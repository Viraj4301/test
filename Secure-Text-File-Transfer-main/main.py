...
def opendirectoryEnc():
	directory = tkFileDialog.askdirectory(initialdir = "/home/Viraj/Desktop",title = "Select directory")
...
#	ABOUT US PART
	...
	udaysocial = Label(Aboutus, text="VirajKumar Makwana")
	udaysocial.grid(row=5, sticky='SW',padx = 8)
	text3 = Label(Aboutus, text="|")
	text3.grid(row=5)
	charansocial = Label(Aboutus, text="Harpal Sinh Chahuhan")
